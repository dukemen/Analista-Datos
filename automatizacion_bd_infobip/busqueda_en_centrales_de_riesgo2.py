...
EXPORT_FOLDER = r"C:\Users\PCSISTEMAS\Documents\INFOBIP\Busquedas_Centrales_de_Riesgo_Enviadas"  # Nueva carpeta para exportaciones
...
def consultar_por_celular(numero_celular, exportar_excel=True):
    ...
    try:
        ...
        if exportar_excel:
            ...
            archivo_excel = f"{numero_celular}_{fecha_hoy}.xlsx" #cualquier cosa si necesitamos poner un nombre al inicio del archivo va antes del corchete de numero_celular
